      ...
      <main className="flex-1 container py-8 md:py-12 relative z-10">
        <div className="max-w-5xl mx-auto pt-6 md:pt-10">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-2/5">
              <div className="aspect-w-1 aspect-h-1">
                <AspectRatio ratio={1/1} className="rounded-3xl overflow-hidden">
                  <div className="w-full h-full bg-nm-accent-gradient p-1 rounded-3xl shadow-nm-lg">
                    <div className="w-full h-full rounded-3xl flex items-center justify-center bg-gradient-to-br from-base-charcoal/90 to-base-space-blue/80 backdrop-blur-lg p-12">
                      <Sparkles className="text-accent-amethyst w-28 h-28 animate-pulse-subtle" />
                    </div>
                  </div>
                </AspectRatio>
              </div>
            ...
            <div className="w-full md:w-3/5 text-center md:text-left">
              <div className="inline-flex items-center justify-center mb-4 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 shadow-nm-sm">
                <span className="text-xs font-semibold text-accent-glow-cyan">ESDT TOKEN CREATION</span>
              </div>
              
              <h1 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-accent-glow-cyan to-accent-amethyst mb-4">
                Issue Your Custom Token
              </h1>
              
              <p className="text-muted-foreground text-lg mb-8 max-w-md">
                Create your custom ESDT token on the MultiversX blockchain in minutes with our guided wizard process.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <button 
                  onClick={() => {}}
                  className="btn neo-button px-6 py-3 text-base font-medium"
                >
          ...
          <div className="mt-12 md:mt-16 bg-white/60 dark:bg-card/60 backdrop-blur-md border border-white/10 rounded-xl shadow-nm-lg p-6 md:p-8 animate-fade-in">
            <div className="mb-6">
              <h2 className="text-xl md:text-2xl font-semibold mb-2">Create Your MultiversX Token</h2>
              <div className="h-1 w-20 bg-nm-accent-gradient rounded-full"></div>
            </div>
