...
import TokenIssuanceWizard from "@/features/TokenIssuanceWizard/TokenIssuanceWizard";
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
                            ...
                            <div className="w-full md:w-3/5 text-center md:text-left">
                                <div className="inline-flex items-center justify-center mb-4 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 shadow-nm-sm">
                                    <span className="text-xs font-semibold text-accent-glow-cyan">
                                        ESDT TOKEN CREATION
                                    </span>
                                </div>
                                ...
                                <p className="text-muted-foreground text-lg mb-8 max-w-md">
                                    Create your custom ESDT token on the
                                    MultiversX blockchain in minutes with our
