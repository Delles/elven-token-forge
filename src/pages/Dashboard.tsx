    ...
    return (
        <ProtectedRoute>
            <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-background/95 to-secondary/5">
                {/* Global Header is now handled by MainLayout */}
                    ...
                    <div className="md:flex md:justify-between md:items-center mb-8">
                        <div>
                            ...
                            <p className="text-foreground/70 mb-4">
                                Manage your ESDT tokens with comprehensive
                                analytics and controls
                            </p>
                            <Button
                                onClick={handleIssueNewToken}
                                size="sm"
                                className="text-sm bg-nm-accent-gradient text-white shadow-nm-sm hover:shadow-nm-md transition-all mb-8 md:mb-0"
                            >
                        ...
                        <Card className="max-w-2xl mx-auto bg-white/80 dark:bg-card/80 shadow-nm-md">
                            <CardContent className="py-12 text-center">
                                ...
                                <div className="flex justify-center">
                                    ...
                                    >
                                        <Plus className="h-4 w-4 mr-2" /> Launch
                                        a New Token
                                    </Button>
                                </div>
                            </CardContent>
